    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        try {
            ...
            if (StringUtils.hasText(jwt) && jwtTokenProvider.validateToken(jwt)) {
                ...
                UUID merchantId = merchantIdStr != null ? UUID.fromString(merchantIdStr) : UUID.fromString(claims.getSubject());
                ...
                MerchantPrincipal principal = new MerchantPrincipal(
                        ...
                        name,
                        null,
                        com.recoverai.backend.entity.enums.MerchantStatus.ACTIVE,
            ...
            log.warn("Could not set merchant authentication in security context: {}", e.getMessage());
        }
